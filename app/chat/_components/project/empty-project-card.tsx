...
const EmptyProjectCard = ({
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-6 items-center w-full justify-center h-full p-12 rounded-lg border-2 border-dashed border-line">
        <div className="flex flex-col gap-[6px] items-center">
          <MessageCircleMore size={24} className="text-label-strong" />
          <p className="text-title-l text-label-strong">
            이 프로젝트의 새로운 대화를 시작해보세요.
          </p>
          <p className="text-body-s text-label-alternative">
