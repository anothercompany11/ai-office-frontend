      ...
      <div className="relative">
        <form onSubmit={handleSubmit} className="flex relative">
          <textarea
            ...
            className="w-full bg-white disabled:bg-gray-100 rounded-lg shadow-[0px_16px_14px_0px_rgba(0,0,0,0.1)] tab:rounded-[20px] resize-none text-body-2 focus-visible:outline-none py-6 px-6"
            rows={1}
            maxLength={150}
